        ...
        function showgrid(data) {
            $("#table_list_2").jqGrid({
                ...
                colModel: [
                    ...
                    { name: 'logo', index: 'logo', editable: true, width: 100,},
                    {
                        name: 'id', index: 'id', editable: false, width: 90, search: false,
                        formatter: function (cellvalue, options, rowObject) {

                            return "<a class='btn btn-default btn-xs' href='/customer/qes_body/"+ rowObject.id + "/developer/' ><i class='fa fa-info'></i> 预览</a> ";
