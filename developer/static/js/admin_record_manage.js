    ...
    init: function () {
        ...
        function showgrid(data) {
            $("#table_list_2").jqGrid({
                ...
                colModel: [
                    { name: 'user', index: 'user', editable: false , search: true,width: 60},
                    { name: 'questions_name', index: 'questions_name', editable: false, width: 120, search: true , searchoptions:{sopt:['eq','ne']},},
                    { name: 'questions_id', index : 'questions_id', editable: false, search:false,width: 60},
